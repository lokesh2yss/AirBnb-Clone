      ...
      <div className='space-y-4'>
        <div className='flex gap-4 mx-5'>
          <div className='border-r border-border pr-4'>
            ...
            <div className='mt-3 relative px-4 py-1 border border-border 
            before:absolute before:size-4 before:rotate-[44deg] 
            before:bg-background before:-top-2 before:left-2
            before:border-t before:border-l before:border-border'>
